...
[docs/pi-supervision-branch.md](pi-supervision-branch.md#two-stage-noise-filter) owns branch-outcome delivery, including follow-up turns, rendered notes, and the already-published merge exception.
