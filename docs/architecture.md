...
[docs/pi-supervision-branch.md](pi-supervision-branch.md) owns row eligibility, dispatch architecture, and outcome delivery, and every other harness keeps the wake-to-main path unchanged.
